            ...
            <div class="m-portlet__body">
                <div class="contains">
                    <div class="col-sm-12 CommentContainer" style="float : none;">
                        ...
                        <?php
                        if (isset($MessageDetails) && !is_null($MessageDetails)){
                                                ...
                                                <div class="panel panel-default arrow right">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="comment-post text-break">
                                                                ...
                                                                <?php echo htmlspecialchars_decode($Message->Message_Details) ?>
...
<script src="vendors/jquery-paginate-master/src/jquery.paginate.js" type="text/javascript"></script>
