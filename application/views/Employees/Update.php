                                        ...
                                        <div class="form-group m-form__group row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" min="1" name="nmess" value="<?php echo $user[0]->num_message?>"
                                                           class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-6">
                                                <div class="m-form__group row" style="margin-right: 20px">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="d-flex">
                                                            <label for="example-time-input" class="col-lg-3 col-form-label"> كلمه السر </label>
                                                            <div class="col-lg-9">
                                                                <div class="input-group">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="border d-flex justify-content-center">
                                                    <img id="blah" type="image" src="<?=($user[0]->Image)? $url."ProfielsImages/".$user[0]->Image: ""?>" alt="">
