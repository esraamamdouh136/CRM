        ...
        <div class="col-lg-4 col-sm-12">
            <div class="input-group date">
                ...
                <div class="input-group-append" style="display: block;">
											...
											<span class="input-group-text  m-input " >
...
<script>
    ...
    // });
    //
    // $('#DatebakerInput1').on('dp.change', function(e){
    //     alert(123123);
    // });
    // $(".DatebakerInput1").change(function () {
    //     var datetime=$(this).parent().siblings(".DatebakerInput");
    //    // debugger
    //    var data = $(datetime).val();
    //
    //
    // })
</script>