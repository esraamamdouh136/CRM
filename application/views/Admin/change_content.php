                    ...
                    <div class="m-portlet">
                        <div class="m-portlet__body tabs_border">
                            <ul class="nav nav-tabs"
                                ...
                                <li class="nav-item m-tabs__item ">
                                    <a class="nav-link m-tabs__link" data-toggle="tab" href="#notifyTap"
                                       role="tab">التنبيهات</a>
                                </li>
                            ...
                            <div class="tab-content">
                                                            ...
                                                            <?php if(isset($noanswer)){
                                                                for($i=0;$i<count($noanswer);$i++){?>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <button class="btn btn-outline-danger" statusid="<?php echo $noanswer[$i]->id?>" style="margin-right: 15px">حذف</button>
                                                                        </div>
                                                            ...
                                                            <?php if(isset($answer)){
                                                                for($i=0;$i<count($answer);$i++){?>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <button class="btn btn-outline-danger" statusid="<?php echo $answer[$i]->id?>" style="margin-right: 15px">حذف</button>
                                                                        </div>
                                                                    </div>
                                                                <?php }} ?>
                                                            <div class="row my-5">
                                                            ...
                                                            <?php if(isset($reserve)){
                                                                for($i=0;$i<count($reserve);$i++){?>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <button class="btn btn-outline-danger" statusid="<?php echo $reserve[$i]->id?>" style="margin-right: 15px">حذف</button>
                                                                        </div>
                                                                    </div>
                                                                <?php }} ?>
                                                            <div class="row my-5">
                                                            ...
                                                            <?php if(isset($wrongData)){
                                                                for($i=0;$i<count($wrongData);$i++){?>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <button class="btn btn-outline-danger" statusid="<?php echo $wrongData[$i]->id?>" style="margin-right: 15px">حذف </button>
                                                                        </div>
                                                                    </div>
                                                                <?php }} ?>
                                                            <div class="row my-5">
                                                            ...
                                                            <?php if(isset($showContracted)){
                                                                for($i=0;$i<count($showContracted);$i++){?>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-1">
                                                                            <button class="btn btn-outline-danger" statusid="<?php echo $showContracted[$i]->id?>" style="margin-right: 15px">حذف</button>
                                                                        </div>
                                                                    </div>
                                                                <?php }} ?>
                                                            <div class="row my-5">
                                ...
                                <div class="tab-pane" id="notifyTap" role="tabpanel">
                                    <div class="m-accordion m-accordion--bordered" id="m_accordion_2"
                                         role="tablist">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <label class="col-lg-2" style="width: auto">وقت التنبية للادمن(بالدقائق)</label>
                                                <input id="notifyTime" type="text" class="col-lg-2 form-control" style="display: inline" value="<?= isset($notifyTime)?$notifyTime:0?>">
                                                <button id="SaveNotify" class="col-lg-1 btn btn-info px-5">حفظ</button>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    $("#SaveNotify").click(function () {
        var time = $("#notifyTime").val();
        $.ajax({
            type: "POST",
            url: base + "CRM_Users/SaveNotify",
            data: ({
                newTime: time
            }),
