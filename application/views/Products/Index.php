                                                ...
                                                if(isset($products)){ for($i=0;$i<count($products);$i++){?>
                                                    <tr protype="1" class="unread"  ><!-- new email class: unread -->
                                                        ...
                                                        <td class="col-subject">
                                                            <a data-toggle="modal" data-target="#EditProduct" productId="<?php echo $products[$i]->Product_ID?>" class="btn btn-outline-success EditProduct">

                                                                تعديل</a>
                                                            <button class="btn btn-outline-danger deleteProduct" productId="<?php echo $products[$i]->Product_ID?>">
                                                                حذف
                                                            </button>
                                                        </td>
                                                    </tr>
                                            ...
                                            <table class="table m-table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="example-2" role="grid" aria-describedby="m_table_1_info" style="width: 974px;">
                                                ...
                                                if(isset($services)){ for($i=0;$i<count($services);$i++){?>
                                                    <tr protype="2" class="unread" >
                                                        ...
                                                        <td class="col-subject">
                                                            <a data-toggle="modal" data-target="#EditProduct" productId="<?php echo $services[$i]->Product_ID?>" class="btn btn-outline-success EditProduct">

                                                                تعديل</a>
                                                            <button class="btn btn-outline-danger deleteProduct" productId="<?php echo $services[$i]->Product_ID?>">
                                                                حذف
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form">
                    <label> الوصف </label>
                    <textarea  name="ProductDescription" class="form-control ckeditor" placeholder="الوصف"  ></textarea>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form">
                    <label> الوصف </label>
                    <textarea  name="ProductDescription" id="ProductDescription" class="form-control ckeditor" placeholder="الوصف"  ></textarea>
                </div>
