                                            ...
                                            <table class="table m-table" id="example"
                                                ...
                                                <tr role="row">
                                                    <th class="sorting" tabindex="0" aria-controls="example"
                                                        ...
                                                        <input type="checkbox" value="" id="selectall" class="chk">
                                                    </th>
                                                ...
                                                <?php if(isset($empClients)){ for($i=0;$i< count($empClients);$i++){
                                                    ...
                                                    <tr class="clickable-row task-list-row"
                                                        ...
                                                        <td class="TD">
                                                            <input type="checkbox" class="checkboxMy" custid='<?php echo $empClients[$i]->customerCrmId?>'>
...
<script>
    $("#button11").click(function () {
        ...
        for (var x=0; x < selectAll.length; x++){
            if(selectAll[x].checked){
                customersids += $(selectAll[x]).attr("custid")+',';
                count++;
            }
        }
    ...
    $("#deleteData").click(function () {
        ...
        for (var x=0; x < selectAll.length; x++){
            if(selectAll[x].checked){
                customersids[count] = $(selectAll[x]).attr("custid");
                count++;
            }
        }
        if (count > 0) {
