                    ...
                    <div id="dialog2" title="ارسال رساله " style="display:none;">
                        ...
                        <div class="mail-body">
                            ...
                            <div class="mail-compose">
                                <form method="post"action="<?php echo $url.'CRM_Messages/sendMessage'?>">
                            ...
                            <table class="table mail-table" id="myTable">
                                ...
                                if(isset($sent)){for($i=0;$i<count($sent);$i++){?>
                                    <tr class="unread" data-toggle="modal" ><!-- new email class: unread -->
                                        ...
                                        <td class="col-name">
                                            <a  class="col-name"><?php echo get_Emp_name($sent[$i]->From_User,1)?></a>
                                        </td>
                                        <td class="col-subject">
                                            <a >
                                                ...
                                                if($sent[$i]->To_User==0){
                                                    ...
                                                    echo get_Emp_name($sent[$i]->To_User,2);
                                                }
                                                else
                                                {
                                                    echo get_Emp_name($sent[$i]->To_User,1);
                                                }
                                                ?>
                                            </a>
                                        </td>
                        ...
                        <div class="tab-content">
                            <table class="table mail-table" id="table_id2">
                                ...
                                <?php if(isset($received)){ for($i=0;$i<count($received);$i++){?>
                                    <tr class="unread" data-toggle="modal"><!-- new email class: unread -->
                                        <td>
                                            <a href=<?php echo $url."users/message_details/1/".$received[$i]->ID?>><?php  echo $received[$i]->ID?></a>

                                        </td>

                                        <td class="col-name">

                                            <a  class="col-name"><?php echo get_Emp_name($received[$i]->From_User,1)?></a>
                                        </td>
                                        <td class="col-subject">
                                            <a >
                                                <?php
                                                if($received[$i]->To_User==0){
                                                    ...
                                                    echo get_Emp_name($received[$i]->To_User,2);
                                                }
                                                else
                                                {
                                                    echo get_Emp_name($received[$i]->To_User,1);
                                                }
                                                ?>
                                            </a>
                                        </td>
                                        ...
                                        <td class="col-subject">
                                            <a >
                                                <?php echo $received[$i]->Message?>
                                            </a>
                                        </td>

                                        <td class="col-subject">
                                            <a >
                                                <?php echo $received[$i]->Send_Date	?>
                                            </a>
                                        </td>

                                        <td class="col-subject">
                                            <button class="btn btn-danger btn-sm" mess="<?php echo $received[$i]->ID?>"><i class="entypo-trash"></i>مسح </button>
                                        </td>
