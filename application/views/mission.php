...
<!--                <th>تاريخ نهايه المكالمة</th>-->
            ...
            <?php if(isset($clients)){ for($i=0;$i< $remainder;$i++){
                ...
                <tr id="task-1" class="task-list-row" data-priority="<?php echo $status?>">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="<?php echo $clients[$i]->customerCrmName?>"><a href="<?php echo $url.'users/customer/'.$clients[$i]->customerCrmId?>"><?php echo $clients[$i]->customerCrmName?></td>
