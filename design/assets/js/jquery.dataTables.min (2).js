...
(function (h) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "اظهار _START_ من _END_ من_TOTAL_ اجمالي",
            sInfoEmpty: "showing to 0 of 0 entries 0",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "اظهار _MENU_ اجمالي",
    ...
    m.ext = x = {
        buttons: {},
        classes: {},
        build: "dt/dt-1.10.16/af-2.2.2/b-1.5.1/kt-2.3.2/r-2.2.1/sc-1.4.4/sl-1.2.5",
        errMode: "alert",
        feature: [],
        search: [],
        selector: {
