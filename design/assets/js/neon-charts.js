	...
	$(document).ready(function()
	{
		...
		if(typeof Morris != 'undefined')
		{
			...
			Morris.Donut({
				...
				colors: ['#00a651', '#00bff3', '#f26c4f', '#0072bc']
			});
			...
			Morris.Donut({
				element: 'chart6',
				data: [
					{label: "جديد", value: getRandomInt(10,50)},
					{label: "جاري", value: getRandomInt(10,50)},
					{label: "منتهي", value: getRandomInt(10,50)},
				],
				labelColor: '#303641',
			...
			Morris.Donut({
				element: 'chart7',
				data: [
					{value: 20, label: 'foo', formatted: 'at least 20%'},
					{value: 15, label: 'bar', formatted: 'approx. 15%'},
					{value: 48, label: 'baz', formatted: 'approx. 10%'},
					{value: 5, label: 'A really', formatted: 'at most 5%'},
                                        {value: 12, label: 'New', formatted: 'at most 50% red'},
				],
				formatter: function (x, data) { return data.formatted; },
				colors: ['#f26c4f', '#00a651', '#00bff3', '#0072bc', '#d20202']
			});
