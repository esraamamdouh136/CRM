                                                ...
                                                if(isset($Transfer)){ for($i=0;$i<count($Transfer);$i++){?>
                                                    <tr protype="1" class="unread"  ><!-- new email class: unread -->
                                                        ...
                                                        <td class="col-subject">
                                                            <a data-toggle="modal" data-target="#EditTransfer" TransferID="<?php echo $Transfer[$i]->transfer_ID?>" class="btn btn-blue btn-sm icon-left EditTransfer">
                                                                <i class="flaticon flaticon-edit"></i>
                                                                تعديل</a>
                                                            <button class="btn btn-danger deleteTransfer" TransferID="<?php echo $Transfer[$i]->transfer_ID?>">
                                                                 مسح  <i class="flaticon-delete"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
                                                <?php } }?>
                                            ...
                                            <table class="table m-table  table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="example_1" role="grid" aria-describedby="m_table_1_info" style="width: 974px;">
                                                ...
                                                if(isset($PaymentTypes)){ for($i=0;$i<count($PaymentTypes);$i++){?>
                                                    <tr protype="1" class="unread"  ><!-- new email class: unread -->
                                                        ...
                                                        <td class="col-subject">
                                                            <a data-toggle="modal" data-target="#EditPayment" PaymentID="<?php echo $PaymentTypes[$i]->ID?>" class="btn btn-blue btn-sm icon-left EditPayment">
                                                                <i class="flaticon flaticon-edit"></i>
                                                                تعديل</a>
                                                            <button class="btn btn-danger deletePayment" PaymentID="<?php echo $PaymentTypes[$i]->ID?>">
                                                             مسح <i class="flaticon-delete"></i>
                                                            </button>
                                                        </td>
                                                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <label> الوصف </label>
                    <textarea  name="transferDescription" class="form-control" placeholder="الوصف" cols="30" rows="5" ></textarea>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-row">
                    <label> الوصف </label>
                    <textarea  name="transferDescription" id="transferDescription" class="form-control" placeholder="الوصف" cols="30" rows="5" ></textarea>
                </div>
