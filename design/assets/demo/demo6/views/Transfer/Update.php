            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group">
                                    <input type="number" class="form-control" min="0" value="<?=$Transfer->Price ?>"
                                        name="transferPrice" placeholder=" تكلفة الشحن">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    <textarea name="transferDescription" class="form-control" placeholder="الوصف" cols="50"
                                        rows="5"><?=$Transfer->Description ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-2 col-sm-offset-4">
                        <input type="submit" style="margin-top: 20px;" class="btn btn-blue btn-lg btn-block" value="حفظ">
                    </div>
                </div>
            </div>
            </form>
