        ...
        <div class="panel panel-primary" data-collapsed="0">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input type="text" name="ProductName" class="form-control" placeholder="إسم المنتج / الخدمه" >
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="input-group">
                            <input type="number" class="form-control" min="0" value="0" name="ProductPrice" placeholder="السعر" >
                        </div>
                    </div>
