...
<div class="m-grid__item m-grid__item--fluid m-wrapper" style="margin: 1% 10% 0% 3% ;">
                            ...
                            <div class="m-widget24">
                                <div class="m-widget24__item">
                                    ...
                                    <div class="progress m-progress--sm">
                                        <div class="progress-bar m--bg-success" role="progressbar" style="width: 78%;" aria-valuenow="50" aria-valuemin="51" aria-valuemax="100"></div>
                                    </div>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-3 hight_card bg-white">
                            ...
                            <div class="m-widget24">
                                <div class="m-widget24__item">
                                    ...
                                    <span class="m-widget24__stats m--font-barnd" data-start="0" data-end="<?= isset($clients)?count($clients):0 ?>" data-postfix="" data-duration="1500" data-delay="600">
                                          <?= isset($clients)?count($clients):0 ?>
												</span>
