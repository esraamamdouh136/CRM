...
<div class="m-grid__item m-grid__item--fluid m-wrapper" style="margin-right:8%">
    ...
    <div class="m-content">
        <div class="container">
            ...
            <!--Date And Time-->
            <div class="my-3" id="parent-div">
                <div class="m-portlet__body  m-portlet__body--no-padding">
                    <div class="row m-row--no-padding m-row--col-separator-sm hight_card2">
                        <div class="col-md-12 col-lg-6 col-xl-3 hight_card1 bg-white">
                            ...
                            <div class="m-widget24">
                                <div class="m-widget24__item">
                                    ...
                                    <div class="progress m-progress--sm mt-3">
                                        <div class="progress-bar m--bg-info" role="progressbar" style="width: 78%;"
                                    ...
                                    <div class="m-widget24">
                                        ...
                                        <?= $value['counter']?>
                                            ...
                                            <div class="m-widget14__chart" style="height:120px;">
                                                ...
                                                <canvas id="ch<?php echo $count; ?>" width="286" height="120"
                                        ...
                                        <div class="col-md-2 space mb-3">
                                            <a href="<?php echo base_url() ?>Client/create"
                                               class="btn btn-info btn-block"><i
                                                        class="flaticon flaticon-users ml-2"></i>إضافة عميل</a>
                                    ...
                                    <table id="example"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                ...
                                                aria-label="الشركة: activate to sort column ascending">الشركة<i
                                                        class="la la-building-o ml-2"></i>
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="m_table_1" rowspan="1"
                                                colspan="1" style="width: 150px;"
                                        ...
                                        <?php if(isset($Clients)){ for($i=0;$i<count($Clients);$i++){
                                            ...
                                            <tr class="clickable-row task-list-row" style="cursor: pointer;"
                                                ...
                                                <td class="checkable-td">
                                                    <input type="checkbox" class="checkboxMy
                              <?php echo 'chk elem'.$i?>">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="col-lg-12">
                        <input class="form-control m-input" type="text" value="" id="mailTitle">
                    </div>
                </div>
                <div class="form-group m-form__group row">
                    <label for="example-time-input" class="col-lg-12 col-form-label"> نص الرساله </label>
                    <div class="col-lg-12">
                        <textarea cols="60" rows="5" id="mailBody"></textarea>
                    </div>
                </div>

            </div>
            <div class="modal-footer">
                <button type="button" id="sendMail" class="btn btn-info"> ارسال </button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">غلق</button>
            </div>
        </div>
    </div>
