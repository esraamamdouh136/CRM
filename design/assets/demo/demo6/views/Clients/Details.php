                                    ...
                                    <div class="m-stack m-stack--ver m-stack--desktop m-stack--demo">
                                        <div class="m-stack__item <?= ((isset($callStatus) && $callStatus == 3)||(isset($Orders) && count($Orders) > 0))? 'm-stack__item--center':'m-stack__item--right'?>">
                                            ...
                                            <span class="m-nav__link-text">
                                                <a href="<?php echo base_url() ?>Client/edit/<?php echo $customer_id ?>"
                                                   name="" id="" class="btn btn-info w-25 mt-2" role="button"> تعديل &
                                                    المزيد</a>
                                            </span>
                                        </div>
                                        <?php if ((isset($callStatus) && $callStatus == 3)||(isset($Orders) && count($Orders) > 0)){?>
                                            <div class="m-stack__item m-stack__item--center" style="color:white;">
                                                <a name="" id="showDialog" class="btn btn-success w-25 mt-2" role="button">
إضافة طلب شراء</a>
                                                    ...
                                                    <div class="m-accordion__item-content">
                                                        ...
                                                        <div class="form-group">
                                                            <div class=row>
                                                                ...
                                                                <div class="col-lg-8">
                                                                <textarea class="form-control estext w-100" rows="7"
                                                    ...
                                                    >
                                                        ...
                                                        <?php if(isset($Orders)){ for($i=0;$i< count($Orders);$i++){
                                                            ...
                                                            <tr class="table-row" >
                                                                ...
                                                                <td class="op">
                                                                    <a class="btn btn-green" href="<?php echo base_url()."ClientOrders/OrderDetails/".$Orders[$i]->ID ?>"> <span class="entypo-window" style="cursor: pointer"></span> تفاصيل </a>
                                                                    <button class="btn btn-danger btn-md deleteCustomerOrder" orderID = "<?php echo $Orders[$i]->ID ?>" > <span class="entypo-cancel" style="cursor: pointer"></span>  حذف<i class="flaticon-delete ml-2"></i> </button>
                                                                </td>
                                                            </tr>
                                                        <?php } }?>
                                                        </tbody>
                                ...
                                <div class="comment container ml-3">
                                    ...
                                    <div class="form-group m-form__group row">
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                        <textarea type="text" id="new-comment" class="form-control" placeholder="أكتب تعليقك"
                                                            ...
                                                            <div class="m-widget3__item">
                                                                <div class="m-widget3__header">
                                                                    <div class="m-widget3__user-img border p-2 mt-2">
                                                                        <img class="m-widget3__img" src="assets/images/user-avatar-placeholder.png" alt="">
                                                                    </div>
                    ...
                    <div class="tab-pane" id="m_tabs_6_2" role="tabpanel">
                        ...
                        <div class="new-case m-portlet__body w-100 d-none" id="renewStatusDiv">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <div class="input-group date">
                                        <input type="text" class="form-control m-input " id="m_datetimepicker_1">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="flaticon-calendar glyphicon-th"></i>
                                            </span>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    <div class="input-group date">
                                        <input type="text" class="form-control m-input" id="m_datetimepicker_2">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="flaticon-time glyphicon-th"></i>
                                            </span>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-9 col-md-9 col-sm-12">
                                    ...
                                    <textarea class="form-control" rows="7" cols="50"></textarea>
                            ...
                            <div class="new-case m-portlet__body w-100 " style="display: none;" id="noanswer">
                                <form method="post" onSubmit = "return checkForm(event,this)" action="<?php echo $url."users/update_status"?>">
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-8 col-sm-12">
                                            <div class="input-group date">
                                                <input type="text" class="form-control m-input DatebakerInput callDate"
                                                       name="date">
                                                <div class="input-group-append">
														<span class="input-group-text">
															<i class="flaticon-calendar glyphicon-th"></i>
                                    ...
                                    <div class="form-group m-form__group row">
                                        ...
                                        <div class="col-lg-8 col-md-9 col-sm-12">
                                         ...
                                         <textarea type="text" id="comment" name="comment" class="form-control" placeholder="أكتب تعليقك"
                                                   rows="10" cols="33"></textarea>
                        ...
                        <div class="new-case m-portlet__body w-100 " style="display: none;" id="showRenewStatusForm">
                            <form method="post" onSubmit = "return checkForm(event,this)" action="<?php echo $url."users/update_status"?>">
                                <input type="hidden" class="statusid" id="flag_num" name="flag">
                                <input type="hidden" class="CallID" name="CallID" value="0">
                                <input type="hidden" name="call_status_id" value="<?php echo $clientcallStatus?>">
                                <input type="hidden" value="<?php echo $customer[0]->customerCrmId?>" name="clientid">
                                    ...
                                    <div class="m-portlet__body">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <textarea type="text" id="Mailcontent" class="form-control" placeholder="ادخل رسالتك" rows="10" cols="33"></textarea>
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <div class="col-lg-2">
                                                    <button type="button" class="btn btn-info btn-md btn-block mr-auto" id="sendMail">إرسال</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form class="m-form m-form--fit m-form--label-align-right">
                                    <div class="m-portlet__body">
                                        <div class="container">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="control-label col-lg-2 text-center">النوع</label>
                                                    <div class="col-lg-4 d-flex">
                                                        <div class="">
                                                            <label>
...
<script>
    ...
    $(document).ready(function () {
        $("table[id^='example']").DataTable({
            ...
            neworderTable = $("#updateOrderItems").DataTable({
                "language": {
                    "sProcessing": "جارٍ التحميل...",
                    "sLengthMenu": "أظهر _MENU_ مدخلات",
                    "sZeroRecords": "لم يعثر على أية سجلات",
...
<script>
    ...
    $("#AddOrder").click(function () {
        ...
        if (quantity <= 0) {
            ...
            var row = new Array(
                ...
                "<button class='btn btn-danger btn-sm' style='font-weight: bold' discount = '" + discount +
    ...
    function checkForm(e, form) {
        ...
        if (today.getDate() <= d2.getDate() || today.getDate() == d2.getDate()) {
