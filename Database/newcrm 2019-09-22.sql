...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2019 at 06:31 PM
...
(1, 39, NULL, 462, 'شكوة عميل مش محترم', b'0', b'0', b'0', b'0', b'0', b'1', b'0'),
(2, 39, 35, 462, 'شكوة عميل محترم', b'0', b'0', b'0', b'0', b'1', b'1', b'0'),
(3, 39, 35, 462, 'ملاحظة عميل محترم', b'0', b'0', b'0', b'0', b'1', b'1', b'1'),
(4, 39, NULL, 462, 'ملاحظة عميل 2', b'0', b'0', b'0', b'0', b'0', b'0', b'1');
...
(36, 36, 481, '2019-09-17', '15:26:22', '15:27:13', 21, 1),
...
(16, 36, b'1', b'1', b'1', b'1', b'1', b'1', 18, b'0', b'1'),
...
(1, 36, 481, 'العميل هيدرس العرض وهيتصل ????', '2019-09-17', '15:27:13', b'1', 18),
...
CREATE TABLE `crm_messages` (
  ...
  `receiver_Deleted` bit(1) NOT NULL DEFAULT b'0',
  `Sender_Deleted` bit(1) NOT NULL DEFAULT b'0',
  `Admin_Deleted` bit(1) NOT NULL DEFAULT b'0',
  `Is_Seen` bit(1) NOT NULL DEFAULT b'0',
  `Admin_Seen` bit(1) NOT NULL DEFAULT b'0'
...
INSERT INTO `crm_messages` (`ID`, `From_User`, `To_User`, `Titel`, `receiver_Deleted`, `Sender_Deleted`, `Admin_Deleted`, `Is_Seen`, `Admin_Seen`) VALUES
(1, 33, 3, 'final ', b'1', b'0', b'1', b'0', b'0'),
(2, 32, 3, 'e2e', b'1', b'0', b'1', b'1', b'1'),
(3, 39, 38, 'test', b'0', b'1', b'1', b'0', b'0'),
(4, 39, 40, 'test', b'0', b'1', b'1', b'0', b'1'),
(6, 39, 32, 'صباح الخير صباح الخير صباح الخير صباح الخيرصباح الخير صباح الخيرصباح الخير صباح الخيرصباح الخير صباح', b'0', b'0', b'0', b'1', b'1'),
(7, 39, 35, 'صباح الخير صباح الخير صباح الخير صباح الخيرصباح الخير صباح الخيرصباح الخير صباح الخيرصباح الخير صباح', b'0', b'0', b'0', b'1', b'1');
...
INSERT INTO `crm_products` (`Product_ID`, `Product_Name`, `Product_Type`, `Price`, `Description`, `Cancel_IN`) VALUES
(5, 'دليل تارجيت الاصدار الاول', 1, 100, 'دليل الشريكات المصرية', 0),
(7, 'دليل تارجيت الاصدار الثانى', 1, 150, 'تحديث دليل تارجيت الاصدار الاول', 0),
(8, 'سيريال', 2, 10, 'سيريال تفعيل برنامج الدليل', 0);
...
INSERT INTO `crm_sms` (`ID`, `UserID`, `ClientID`, `Phone`, `MessageText`, `Date`) VALUES
(1, 39, 461, '201140218187', 'test SMS', '2019-09-18'),
(3, 39, 462, '201114355330', 'sms test sms test sms test sms test sms test sms test sms test sms test sms test sms test sms test ', '2019-09-18'),
(4, 3, NULL, '201114355330', '00', '2019-09-19');
...
INSERT INTO `crm_users` (`ID`, `Name`, `Email`, `Phone`, `Address`, `Gender`, `BirthDate`, `Salary`, `AnnInc`, `SellInc`, `JoinDate`, `UserName`, `Pass`, `Type`, `Super`, `active`, `num_message`) VALUES
(3, 'admin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin1', '827ccb0eea8a706c4c34a16891f84e7b', 1, NULL, 1, 30),
(32, 'هبه', 'abdob2623@gmail.com', '01114355330', 'test', NULL, '2019-04-30', 1, 1, 1, '2019-07-02', 'heba', '202cb962ac59075b964b07152d234b70', 2, NULL, 1, 10),
(33, 'منار', 'abdob2623@gmail.com111', '01114355330', 'test', NULL, '2019-05-27', 1, 1, 1, '2019-07-29', 'manar', '202cb962ac59075b964b07152d234b70', 3, 32, 1, 10),
(34, 'ريهام', 'abdob2623@gmail.com1', '01114355330', 'test', NULL, '2019-04-02', 1, 1, 1, '2019-05-28', 'reham', '202cb962ac59075b964b07152d234b70', 2, NULL, 1, 10),
(35, 'نعمة', 'abdob2623@gmail.com334', '01114355333', 'test', NULL, '2019-05-08', 1, 1, 1, '2019-07-02', 'nemaa', '202cb962ac59075b964b07152d234b70', 2, NULL, 1, 10),
(36, 'اسماء', 'abdob2623@gmail.com4', '0111435532', 'test', NULL, '2019-02-25', 1, 1, 1, '2019-05-28', 'asmaa', '202cb962ac59075b964b07152d234b70', 3, 32, 1, 10),
(37, 'هدير', 'abdob2623@gmail.com5', '01114355323', 'test', NULL, '2019-07-09', 1, 1, NULL, '2019-08-05', 'hader', '202cb962ac59075b964b07152d234b70', 3, 32, 1, 10),
(38, 'رحمة', 'abdob2623@gmail.com66', '111435533011', 'test', NULL, '2019-04-02', 1, 1, 1, '2019-07-02', 'rahma', '202cb962ac59075b964b07152d234b70', 3, 35, 1, 10),
(39, 'عزة', 'abdob2623@gmail.com7', '01114355330111', 'test', NULL, '2010-02-02', 1, 1, 1, '2019-07-03', 'aza', '202cb962ac59075b964b07152d234b70', 3, 35, 1, 10),
(40, 'داليا', 'abdob2623@gmail.com8', '01114355330223', 'test', NULL, '2010-02-02', 1, 1, 1, '2019-01-29', 'dalya', '202cb962ac59075b964b07152d234b70', 3, 35, 1, 10),
(42, 'testAdministrative', 'abdob2623@gmail.com221', '01114355330', 'test', NULL, '2010-02-02', 1, 1, 1, '2019-08-27', 'Administrative', '202cb962ac59075b964b07152d234b70', 4, 32, 1, 10);
...
(1, 3, '0000-00-00 00:00:00', '2019-09-22 18:26:31', 1),
(5, 32, '0000-00-00 00:00:00', '2019-09-22 15:51:45', 2),
(6, 33, '0000-00-00 00:00:00', '2019-09-16 16:35:45', 2),
(7, 36, '0000-00-00 00:00:00', '2019-09-17 15:50:17', 2),
(8, 39, '0000-00-00 00:00:00', '2019-09-18 17:24:28', 2),
...
(461, 3, 'Sameh Awed', '01140218187', '', 'sharif.farouk@elfaroukegypt.com', '', '', 'استاذ ثانوي', '', 'vandersameh@yahoo.com', '', 0, b'0', '', NULL, '2019-09-14 14:40:49'),
(462, 3, 'Joe Nagy', '01114355330', '', 'hakibaidaria@gmail.com', '', '', 'مهندس برمجيات', '', 'joenagy75@yahoo.com', '', 0, b'0', '', NULL, '2019-09-14 14:40:49'),
...
(490, 3, 'بسكوته حسن', '01114355330', NULL, 'abdob2623@gmail.com', NULL, NULL, 'Head of Sales &amp; Leasing', NULL, 'yari66642@yahoo.com', NULL, NULL, b'0', NULL, NULL, '2019-09-14 14:40:49'),
...
(481, 36, 32, 481, '2019-09-17', '03:27:00', 21, 3, b'0'),
...
(490, 36, 32, 490, '2019-09-17', '03:17:21', 1, 3, b'0'),
...
--
ALTER TABLE `messagecrm`
  MODIFY `CrmMessagesId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `crm_messages`
  ADD CONSTRAINT `crm_messages_ibfk_2` FOREIGN KEY (`From_User`) REFERENCES `crm_users` (`ID`),
  ADD CONSTRAINT `crm_messages_ibfk_3` FOREIGN KEY (`To_User`) REFERENCES `crm_users` (`ID`);
...
--
ALTER TABLE `crm_users_log`
  ADD CONSTRAINT `crm_users_log_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `crm_users` (`ID`),
